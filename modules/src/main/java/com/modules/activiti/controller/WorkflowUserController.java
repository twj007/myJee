...
import com.component.DeleteTaskCmd;
import com.component.SetFLowNodeAndGoCmd;
...
public class WorkflowUserController extends BaseController{
    ...
    public ResultBody list(String eventId){
        ...
        if(task == null){
            ...
            List<SysUser> users = sysUserService.findUserByRole(taskId);
            if(users.size() == 0){
        ...
        if(task == null){
            ...
            if(username != null){
                if(CommonConstants.START.equals(taskId)){
                    ...
                    users = sysUserService.findUserByRole(taskId);
                }
            }
